...
class TestDrawdownManager:
    ...
    async def test_get_or_create_drawdown_creates_new(self):
        ...
        with (
            patch("bot.trading.drawdown_manager.fetchrow") as mock_fetch,
            patch("bot.trading.drawdown_manager.execute") as mock_exec,
        ):
            ...
            from bot.trading.drawdown_manager import get_or_create_drawdown
    ...
    async def test_reset_drawdown_zeros_values(self):
        ...
        with (
            patch("bot.trading.drawdown_manager.execute") as mock_exec,
            patch("bot.trading.drawdown_manager.get_drawdown") as mock_get,
        ):
            ...
            from bot.trading.drawdown_manager import reset_drawdown
    ...
    async def test_resume_trading_sets_paused_false(self):
        ...
        with (
            patch("bot.trading.drawdown_manager.execute"),
            patch("bot.trading.drawdown_manager.get_drawdown") as mock_get,
        ):
            mock_get.return_value = {
                "user_id": 1,
            ...
            from bot.trading.drawdown_manager import resume_trading
    ...
    async def test_get_drawdown_returns_current_state(self):
        ...
        with patch("bot.trading.drawdown_manager.fetchrow") as mock_fetch:
            ...
            from bot.trading.drawdown_manager import get_drawdown
    ...
    async def test_is_trading_paused_returns_false_when_not_paused(self):
        ...
        with patch("bot.trading.drawdown_manager.fetchrow") as mock_fetch:
            ...
            from bot.trading.drawdown_manager import is_trading_paused
    ...
    async def test_update_drawdown_calculates_correctly(self):
        ...
        with (
            patch("bot.trading.drawdown_manager.fetchrow") as mock_fetch,
            patch("bot.trading.drawdown_manager.execute"),
            patch("bot.trading.drawdown_manager.get_or_create_drawdown") as mock_get_or_create,
        ):
            mock_fetch.return_value = {
                "capital_total": Decimal("10000.00"),
                "max_drawdown_percent": Decimal("5.00"),
