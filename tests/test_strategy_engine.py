...
from trading.strategy_engine import SignalDTO, UserConfig, run_cycle, Database
...
def _create_mock_df_with_signals(is_bullish: bool, ash_signal: bool, rr_ratio: float, direction: str) -> pd.DataFrame:
